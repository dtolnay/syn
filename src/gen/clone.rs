...
impl Clone for AttrStyle {
    fn clone(&self) -> Self {
        match self {
            ...
            AttrStyle::Inner(v0) => AttrStyle::Inner(v0.clone()),
        }
    }
}
#[cfg(any(feature = "derive", feature = "full"))]
...
impl Clone for BinOp {
    fn clone(&self) -> Self {
        match self {
            BinOp::Add(v0) => BinOp::Add(v0.clone()),
            BinOp::Sub(v0) => BinOp::Sub(v0.clone()),
            BinOp::Mul(v0) => BinOp::Mul(v0.clone()),
            BinOp::Div(v0) => BinOp::Div(v0.clone()),
            BinOp::Rem(v0) => BinOp::Rem(v0.clone()),
            BinOp::And(v0) => BinOp::And(v0.clone()),
            BinOp::Or(v0) => BinOp::Or(v0.clone()),
            BinOp::BitXor(v0) => BinOp::BitXor(v0.clone()),
            BinOp::BitAnd(v0) => BinOp::BitAnd(v0.clone()),
            BinOp::BitOr(v0) => BinOp::BitOr(v0.clone()),
            BinOp::Shl(v0) => BinOp::Shl(v0.clone()),
            BinOp::Shr(v0) => BinOp::Shr(v0.clone()),
            BinOp::Eq(v0) => BinOp::Eq(v0.clone()),
            BinOp::Lt(v0) => BinOp::Lt(v0.clone()),
            BinOp::Le(v0) => BinOp::Le(v0.clone()),
            BinOp::Ne(v0) => BinOp::Ne(v0.clone()),
            BinOp::Ge(v0) => BinOp::Ge(v0.clone()),
            BinOp::Gt(v0) => BinOp::Gt(v0.clone()),
            BinOp::AddEq(v0) => BinOp::AddEq(v0.clone()),
            BinOp::SubEq(v0) => BinOp::SubEq(v0.clone()),
            BinOp::MulEq(v0) => BinOp::MulEq(v0.clone()),
            BinOp::DivEq(v0) => BinOp::DivEq(v0.clone()),
            BinOp::RemEq(v0) => BinOp::RemEq(v0.clone()),
            BinOp::BitXorEq(v0) => BinOp::BitXorEq(v0.clone()),
            BinOp::BitAndEq(v0) => BinOp::BitAndEq(v0.clone()),
            BinOp::BitOrEq(v0) => BinOp::BitOrEq(v0.clone()),
            BinOp::ShlEq(v0) => BinOp::ShlEq(v0.clone()),
            BinOp::ShrEq(v0) => BinOp::ShrEq(v0.clone()),
        }
    }
}
#[cfg(any(feature = "derive", feature = "full"))]
...
impl Clone for RangeLimits {
    fn clone(&self) -> Self {
        match self {
            RangeLimits::HalfOpen(v0) => RangeLimits::HalfOpen(v0.clone()),
            RangeLimits::Closed(v0) => RangeLimits::Closed(v0.clone()),
        }
    }
}
#[cfg(feature = "full")]
...
impl Clone for TraitBoundModifier {
    fn clone(&self) -> Self {
        match self {
            ...
            TraitBoundModifier::Maybe(v0) => TraitBoundModifier::Maybe(v0.clone()),
        }
    }
}
#[cfg(feature = "full")]
...
impl Clone for UnOp {
    fn clone(&self) -> Self {
        match self {
            UnOp::Deref(v0) => UnOp::Deref(v0.clone()),
            UnOp::Not(v0) => UnOp::Not(v0.clone()),
            UnOp::Neg(v0) => UnOp::Neg(v0.clone()),
        }
    }
}
#[cfg(feature = "full")]
