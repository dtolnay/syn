...
#[cfg(feature = "full")]
pub fn visit_pat_type<'ast, V: Visit<'ast> + ?Sized>(_visitor: &mut V, _i: &'ast PatType) {
    for it in &_i.attrs {
        _visitor.visit_attribute(it)
    }
    _visitor.visit_pat(&*_i.pat);
...
#[cfg(feature = "full")]
pub fn visit_receiver<'ast, V: Visit<'ast> + ?Sized>(_visitor: &mut V, _i: &'ast Receiver) {
    for it in &_i.attrs {
        _visitor.visit_attribute(it)
    }
...
#[cfg(feature = "full")]
pub fn visit_variadic<'ast, V: Visit<'ast> + ?Sized>(_visitor: &mut V, _i: &'ast Variadic) {
    for it in &_i.attrs {
        _visitor.visit_attribute(it)
    }
    tokens_helper(_visitor, &_i.dots.spans);
}
#[cfg(any(feature = "derive", feature = "full"))]
