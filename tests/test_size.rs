...
#[rustversion::attr(since(2022-11-24), cfg_attr(not(target_pointer_width = "64"), ignore))]
#[test]
fn test_expr_size() {
...
#[rustversion::attr(since(2022-09-09), cfg_attr(not(target_pointer_width = "64"), ignore))]
#[test]
fn test_item_size() {
...
#[rustversion::attr(since(2023-04-29), cfg_attr(not(target_pointer_width = "64"), ignore))]
#[test]
fn test_type_size() {
...
#[rustversion::attr(since(2023-12-20), cfg_attr(not(target_pointer_width = "64"), ignore))]
#[test]
fn test_lit_size() {
